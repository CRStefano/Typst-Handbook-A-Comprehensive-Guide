...
#nota[
  ...
  doppie virgolette `"..."` diventano «virgolette angolari»
  (caporali), mentre le singole `'...'` diventano
  "virgolette curve alte" (le stesse che in inglese si
  ottengono dalle doppie virgolette), *non* ‹angolari singole›.
  Con `lang: "en"` si ottengono le "curly quotes" inglesi.
]
...
#block(fill: sfondo, inset: 1em, radius: 5pt)[
  ...
  Questa è una casella in modalità #if dark-mode [scura] else [chiara].
  ]
]
```,
 risultato: [
 ...
 Questa è una casella in modalità #if dark-mode-v [scura] else [chiara].
 ]
 ]
 ],
...
```,
 risultato: [
 #let info-box-f(titolo, corpo) = block(
